/*
 * Bober Clinic note: Contains code or settings for DoctorPhysicalExamination.tsx.
 * File: frontend-main/frontend-main/src/features/doctor/components/DoctorPhysicalExamination.tsx
 */
import {
  Badge,
  Button,
