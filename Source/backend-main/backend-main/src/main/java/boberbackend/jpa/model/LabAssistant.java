/*
 * Bober Clinic note: Contains code or settings for LabAssistant.java.
 * File: backend-main/backend-main/src/main/java/boberbackend/jpa/model/LabAssistant.java
 */
